...
public class ClinicaDataController {
           ...
           private PacienteRepository pacienteRepo;                                         // Injetando o PacienteRepository e também o ClinicaRepository
            ...
            @Autowired
            ClinicaDataController(ClinicaDataRepository clinicosRepo, PacienteRepository pacienteRepo) {      // Criado o Construtor. Terá como passagem de parâmetro ClinicaDataRepository e PacienteRepository
                    this.clinicosRepo = clinicosRepo;
...
/*    @RequestMapping(value = "/dadosclinicos/{pacienteId}/{componenteNome}", method = RequestMethod.GET)
    public List<ClinicaData> getClinicaData(@PathVariable("pacienteId") int pacienteId,
                                             @PathVariable("componenteNome") String componenteNome) {
        return clinicosRepo.findByPacienteIdAndComponenteNomeOrderByMeasuredDateTime(pacienteId, componenteNome);
    }*/
}
